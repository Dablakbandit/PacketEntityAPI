...
public interface IModifiableEntity{
	 ...
	 */
	List<WrappedObject> getWatchableObjects();
	
	/**
	 * Get a {@link WrappedObject} containing the metadata contained by this modifiable entity object.
	 * @return a wrapped data watcher containing the metadata, or null if the implementation does not support getting a
	 * watcher
	 */
	WrappedObject getDataWatcher();
	 ...
	 */
	void write(int index, Object newValue, Object serializer);
